      ...
      <section className="flex flex-wrap justify-center items-center py-10">
        <div className="flex max-md:flex-col justify-between items-center basis-[85%] gap-16">
          <article className="md:w-3/6 text-center lg:text-left elative basis-[45%]">
            <h5 className="font-bold text-navBlueBg ">CONTACT US</h5>
            <h5 className="font-bold text-navBlueBg my-9 text-6xl leading-[80px] ">
              Get in touch today!
            </h5>
            <h4 className="font-normal text-xl text-iconGray lg:w-2/3">
              We know how large objects will act, but things on a small scale
            </h4>
            <h3 className="my-9 text-navBlueBg font-bold text-2xl ">
              Phone : +451 215 215
            </h3>
            <h3 className="mb-9 text-navBlueBg font-bold text-2xl ">
              Fax : +451 215 215
            </h3>
            <div className="flex items-center text-navBlueBg text-3xl justify-center lg:justify-normal">
