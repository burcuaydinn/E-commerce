        ...
        <section className="flex justify-center py-3 max-lg:py-1">
          <div className="flex flex-col items-center basis-[80%]">
            <div className="text-center my-20">
              ...
              <p className="font-normal text-sm text-iconGray py-1">
                Problems trying to resolve the conflict between{" "}
              </p>
            </div>
  
            <div className="flex justify-around flex-wrap w-full gap-10">
              <div className="flex-1 max-md:basis-[100%] text-center">
