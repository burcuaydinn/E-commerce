        ...
        <article className="shadow-lg pr-5 max-sm:py-4 hover:shadow-2xl hover:shadow-iconGray">
          <div className="flex justify-center gap-4 max-sm:flex-wrap">
            <div className="relative basis-[44%] max-sm:basis-[80%] aspect-[2/3.5] max-sm:aspect-[1/1]">
              <img className="w-full h-full" src={postImg} alt="Post" />
            ...
            <div className="flex flex-col gap-2 basis-[53%] max-sm:basis-[80%] aspect-[1/1] justify-evenly">
              <div className="flex justify-between">
                <p className="font-bold text-sm max-sm:text-lg py-1 text-primary">
                  English Department
                </p>
              ...
              <h3 className="text-base max-sm:text-2xl font-bold">Graphic Design</h3>
              <p className="font-normal text-sm  text-iconGray max-sm:text-base">
                We focus on ergonomics and meeting you where you work. It{"'"}s
                only a keystroke away.
              </p>
              <div className="flex gap-1">
                <i className="fa-solid fa-arrow-up-from-bracket text-sm text-iconGray"></i>
